...
music=0
archives=0
echo -e "\n\nq='quit', s='termux-setup-storage', p='Pictures', n='Normal'"
echo -e "\nm='Music', v='Videos', d='Documents', e='Executables'"
echo -e "\na='Archives'"
...
if [ $documents = 1 ]; then
ExternalOut=$(find $sdcardpath -type f \( -iname "*$response*".txt -o -iname "*$response*".md -o -iname "*$response*".rtf -o -iname "*$response*".doc -o -iname "*$response*".docx -o -iname "*$response*".ppt  -o -iname "*$response*".odt -o -iname "*$response*".xls -o -iname "*$response*".html  \) -fprint >(grep -i --color=always $response) 2>/dev/null)
InternalOut=$(find $internalpath -type f \( -iname "*$response*".txt -o -iname "*$response*".md -o -iname "*$response*".rtf -o -iname "*$response*".doc -o -iname "*$response*".docx -o -iname "*$response*".ppt  -o -iname "*$response*".odt -o -iname "*$response*".xls -o -iname "*$response*".html  \) -fprint >(grep -i --color=always $response) 2>/dev/null)
fi
if [ $videos = 1 ]; then
